package com.example.facebookdownloaderci.ui.settings
...
import com.example.facebookdownloaderci.NavActivity
import kotlinx.coroutines.CoroutineScope
import kotlinx.coroutines.Dispatchers
import androidx.work.WorkManager
import androidx.work.workDataOf
import com.example.facebookdownloaderci.work.UpdateYoutubeDLWorker
    ...
    private fun updateYoutubeDL(updateChannelPreference: String){
        ...
        updateScope.launch {
            try {
                ...
                val workTag = "facebook_update_worker"
